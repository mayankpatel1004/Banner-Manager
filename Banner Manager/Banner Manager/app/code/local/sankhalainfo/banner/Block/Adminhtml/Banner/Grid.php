...
class Sankhalainfo_Banner_Block_Adminhtml_Banner_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  ...
  protected function _prepareColumns()
  {
	  ...
	  $this->addColumn('filename', array(
          ...
          'align'     =>'left',
          'index'     => 'filename',
		  'renderer'  => 'banner/adminhtml_banner_grid_renderer_banner'
      ));
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->addItem('delete', array(
             ...
             'confirm'  => Mage::helper('banner')->__('Are you sure Want To Delete the Banner?')
        ));
